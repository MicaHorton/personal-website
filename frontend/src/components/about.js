...
const About = () => (
    <main>
        <section>
            ...
            Check out my <a href='https://www.micahorton.com/projects'>projects</a>
            /<a href='https://www.micahorton.com/blog'>blog</a> or learn more about me at:</p>

            <ul className="icons">
                <li>
                    <i className="fa fa-github"></i>
                    <a href="https://github.com/MicaHorton" target="_blank" rel="noreferrer">GitHub</a>
                </li>
                <li>
                    <i className="fa fa-stack-overflow"></i>
                    <a href="https://stackoverflow.com/users/13029356/mica-horton?tab=profile" 
                    target="_blank" rel="noreferrer">Stack Overflow</a>
                </li>
                <li>
        ...
        <section>
            ...
            <ul>
                <li> President of Adventure Club, the hiking and camping club focused on 
                    going outside even though staying home and programming is fun too. 
                    (See our Instagram @lahsadventureclub.) </li>
                <li> Passed John Hopkins Center of Talented Youth Assessment </li>
                <li> Received Challenger Merit Scholarship </li>
                <li> Studied Spanish for 4 years, currently enrolled in SPAN 5. 
                    Received the silver metal for the NHS Spanish exam. </li>
                <li> Has completed 20 service hours volunteering at the local TV station 
                    (the KMVT) as a cinematographer. </li>
            </ul>
        </section>
