    ...
    return (
        ...
        <div className={styles.box}>
          ...
          <p>I'm an LAHS student living in the Bay Area who loves to code. 
            This website is a tribute to all the prjects I've done. 
        ...
        <div className={styles.box}>
            ...
            <ul>
              <li> President of Adventure Club, the hiking and camping club focused on going outside even when staying home and programming is fun too. (See our Instagram @lahsadventureclub.) </li>
